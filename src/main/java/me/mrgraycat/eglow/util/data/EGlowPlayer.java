...
public class EGlowPlayer {
	...
	public void setColor(ChatColor color, boolean status, boolean fake) {
		...
		if (color.equals(ChatColor.RESET)) {
			...
			switch (getEntityType()) {
				case ("PLAYER"):
					PacketUtil.updateScoreboardTeam(DataManager.getEGlowPlayer(getPlayer()), getTeamName(), ((EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerTagPrefix(this) : "") + color, (EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerTagSuffix(this) : "", EnumChatFormat.valueOf(color.name()));
					break;
				case ("NPC"):
	...
	public void disableGlow(boolean hardReset) {
		if (getFakeGlowStatus() || getGlowStatus()) {
			...
			if (getPlayer() != null) {
				PacketUtil.updateScoreboardTeam(DataManager.getEGlowPlayer(getPlayer()), getTeamName(), (EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerTagPrefix(this) : "", (EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerTagSuffix(this) : "", EnumChatFormat.RESET);
	...
	public void updatePlayerTabname() {
		...
		String prefix = (EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerPrefix(this) : "";
		String suffix = (EGlow.getEGlowInstance().getVaultAddon() != null) ? EGlow.getEGlowInstance().getVaultAddon().getPlayerSuffix(this) : "";
