...
public class EGlowMessageConfig {
	...
	public static void initialize() {
		configFile = new File(EGlow.getEGlowInstance().getDataFolder(), "Messages.yml");
		...
		try {
			...
			if (!configFile.exists()) {
				...
				EGlow.getEGlowInstance().saveResource("Messages.yml", false);
			} else {
			...
			if (!config.isConfigurationSection("main")) {
				File oldFile = new File(EGlow.getEGlowInstance().getDataFolder(), "OLDMessages.yml");
	...
	public enum Message {
		...
		public String get(EGlowPlayer target, String value) {
			switch (msg) {
				case OTHER_CONFIRM:
		...
		public String get(EGlowPlayer target) {
		...
		private String getColorValue(String path, EGlowPlayer ePlayer, String textToReplace, String replacement) {
			String text = config.getString(path);
