...
public class AdvancedGlowVisibilityAddon {
	...
	static {
		...
		InputStream resource = EGlow.getEGlowInstance().getResource("internal/AdvancedGlowIgnoreList.yml");
	...
	public AdvancedGlowVisibilityAddon() {
		...
		}.runTaskTimerAsynchronously(EGlow.getEGlowInstance(), 0, Math.max(EGlowMainConfig.MainConfig.ADVANCED_GLOW_VISIBILITY_DELAY.getInt(), 10));
	}
