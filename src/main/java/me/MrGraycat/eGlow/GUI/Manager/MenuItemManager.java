...
public class MenuItemManager extends MenuManager {
     ...
     */
    public ItemStack createPlayerSkull(EGlowPlayer player) {
     ...
     */
    public ItemStack createLeatherColor(EGlowPlayer player, String color, int red, int green, int blue) {
     ...
     */
    public ItemStack createGlowingStatus(EGlowPlayer player) {
     ...
     * @return color lore
     */
    private String[] createColorLore(EGlowPlayer player, String color) {
        List<String> prelores = new ArrayList<>();
     ...
     * @return info lore
     */
    private String[] createInfoLore(EGlowPlayer player) {
        List<String> prelores = new ArrayList<>();
     ...
     * @return speed lore
     */
    public String[] createSpeedLore(EGlowPlayer player) {
        List<String> prelores = new ArrayList<>();
     ...
     */
    public boolean hasEffect(EGlowPlayer player) {
     ...
     */
    public String hasPermission(EGlowPlayer player, String permission) {
