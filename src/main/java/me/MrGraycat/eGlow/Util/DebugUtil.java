...
public class DebugUtil {
	...
	public static void sendDebug(CommandSender sender, EGlowPlayer ePlayer) {
		...
		if (EGlow.getEGlowInstance().getTABAddon() != null && !EGlow.getEGlowInstance().getTABAddon().isVersionSupported())
			ChatUtil.sendPlainMsg(sender, ChatUtil.translateColors("&cThis eGlow version requires a higher TAB version&f!"), false);
	}
